...
<style>
body {
  background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgEcl6QZIbum4z-nNZPHrFatiFypc4jpkUzw&usqp=CAU');
...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"> NATIONAL BANK <img src="logo.png" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <img src="friend.png" alt="Bank" width="75" height="75" ;"> <strong>Welcoming you in the most trusted NATIONAL Bank !</strong> <img src="logos/trust.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
