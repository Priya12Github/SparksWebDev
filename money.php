...
<style>
body{
          background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTywQIG2czNzyp2YoyznFO-aa0_Drtq_6W3xA&usqp=CAU');
...
<body>
    ...
    <class class="welcome">
        <h2>
            <img src="m1.png" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Money
                Transfer</strong> <img src="m2.png" alt="Bank" width="75" height="75">
        </h2>
    </class>
